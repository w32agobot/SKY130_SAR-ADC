...
set ::env(DESIGN_CONFIG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/config.tcl}
set ::env(DESIGN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native}
...
set ::env(FP_PIN_ORDER_CFG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/pin_order.cfg}
...
set ::env(GLB_CFG_FILE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/config.tcl}
...
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports}
set ::env(RESULTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar}
...
set ::env(START_TIME) {2022.09.09_11.49.03}
...
set ::env(TMP_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp}
...
set ::env(VERILOG_FILES) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/src/adc_clkgen_with_edgedetect_native.v}
set ::env(WIDEN_SITE) {1}
set ::env(WIDEN_SITE_IS_FACTOR) {1}
set ::env(WIRE_RC_LAYER) {met1}
set ::env(YOSYS_REWRITE_VERILOG) {0}
set ::env(cts_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs/cts}
set ::env(cts_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports/cts}
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/cts}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/eco}
set ::env(floorplan_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/placement}
set ::env(routing_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs/routing}
set ::env(routing_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports/routing}
set ::env(routing_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/routing}
set ::env(signoff_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs/signoff}
set ::env(signoff_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports/signoff}
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/signoff}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_DEF) /foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/results/routing/adc_clkgen_with_edgedetect_native.def
set ::env(CURRENT_GUIDE) /foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/routing/10-global.guide
set ::env(CURRENT_INDEX) 23
set ::env(CURRENT_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/signoff/19-powered_netlist.v
set ::env(PREV_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect_native/runs/foobar/tmp/routing/13-detailed.v
