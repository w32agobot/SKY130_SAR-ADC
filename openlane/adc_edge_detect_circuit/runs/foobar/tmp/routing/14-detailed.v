module adc_edge_detect_circuit (VGND,
 ...
 sky130_fd_sc_hd__decap_3 FILLER_13_3 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_13_38 (.VGND(VGND),
    .VPWR(VPWR),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_14_3 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_14_36 (.VGND(VGND),
    .VPWR(VPWR),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_14_48 (.VGND(VGND),
    .VPWR(VPWR),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_14_60 (.VGND(VGND),
    .VPWR(VPWR),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_99 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__and2b_2 _1_ (.A_N(net_2),
    .B(start_conv),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 _2_ (.A(_0_),
    ...
    .VPWR(VPWR),
    .X(ena_out));
 sky130_mm_sc_hd_dly5ns delay_macrocell_0 (.in(ena_in),
    .out(net_1),
    .VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_mm_sc_hd_dly5ns delay_macrocell_1 (.in(net_1),
    .out(net_2),
    .VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
