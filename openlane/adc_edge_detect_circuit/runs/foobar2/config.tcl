...
set ::env(DESIGN_CONFIG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/config.tcl}
set ::env(DESIGN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit}
...
set ::env(EXTRA_GDS_FILES) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/src/sky130_mm_sc_hd_dly5ns.gds}
set ::env(EXTRA_LEFS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/src/sky130_mm_sc_hd_dly5ns.lef}
...
set ::env(FP_PIN_ORDER_CFG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/pin_order.cfg}
...
set ::env(GLB_CFG_FILE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/config.tcl}
...
set ::env(LIB_FASTEST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/src/sky130/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_SLOWEST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/src/sky130/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/src/sky130/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_TYPICAL) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/src/sky130/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports}
set ::env(RESULTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2}
...
set ::env(RUN_TAG) {foobar2}
set ::env(SPEF_EDGE_CAP_FACTOR) {1}
set ::env(SPEF_EXTRACTOR) {openrcx}
set ::env(SPEF_WIRE_MODEL) {L}
set ::env(START_TIME) {2022.09.08_13.39.06}
...
set ::env(TMP_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp}
...
set ::env(VERILOG_FILES) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/src/adc_edge_detect_circuit.v}
set ::env(WIDEN_SITE) {1}
set ::env(WIDEN_SITE_IS_FACTOR) {1}
set ::env(WIRE_RC_LAYER) {met1}
set ::env(YOSYS_REWRITE_VERILOG) {0}
set ::env(cts_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs/cts}
set ::env(cts_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports/cts}
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/cts}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/eco}
set ::env(floorplan_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/placement}
set ::env(routing_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs/routing}
set ::env(routing_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports/routing}
set ::env(routing_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/routing}
set ::env(signoff_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs/signoff}
set ::env(signoff_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports/signoff}
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/signoff}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_DEF) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/results/routing/adc_edge_detect_circuit.def
set ::env(CURRENT_GUIDE) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/routing/12-global.guide
set ::env(CURRENT_INDEX) 24
set ::env(CURRENT_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/signoff/20-powered_netlist.v
set ::env(PREV_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/foobar2/tmp/routing/14-detailed.v
