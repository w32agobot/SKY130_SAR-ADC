...
set ::env(GLB_CFG_FILE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/config.tcl}
...
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports}
set ::env(RESULTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3}
...
set ::env(TMP_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp}
...
set ::env(cts_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs/cts}
set ::env(cts_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports/cts}
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/cts}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/eco}
set ::env(floorplan_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/placement}
set ::env(routing_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs/routing}
set ::env(routing_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports/routing}
set ::env(routing_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/routing}
set ::env(signoff_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs/signoff}
set ::env(signoff_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports/signoff}
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/signoff}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_DEF) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/results/routing/adc_edge_detect_circuit.def
set ::env(CURRENT_GUIDE) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/routing/10-global.guide
set ::env(CURRENT_INDEX) 15
set ::env(CURRENT_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/routing/13-detailed.v
set ::env(PREV_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_circuit/runs/test3/tmp/routing/11-global.v
