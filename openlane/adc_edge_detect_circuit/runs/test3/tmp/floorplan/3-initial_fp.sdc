...
# Wed Aug 31 12:36:40 2022
###############################################################################
current_design adc_edge_detect_circuit
###############################################################################
# Timing Constraints
###############################################################################
create_clock -name clk -period 65.0000 
set_clock_uncertainty 0.2500 clk
set_input_delay 13.0000 -clock [get_clocks {clk}] -add_delay [get_ports {ena_in}]
set_input_delay 13.0000 -clock [get_clocks {clk}] -add_delay [get_ports {start_conv}]
set_output_delay 13.0000 -clock [get_clocks {clk}] -add_delay [get_ports {ena_out}]
###############################################################################
# Environment
###############################################################################
