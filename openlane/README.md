...
Attention: Don't add the following commands. They are often suggested, but they will generate 2 standard-cells with the same name in the merged.unpadded.lef files at detailled routing. The flow will crash with Error
>No vaid access pattern
```
