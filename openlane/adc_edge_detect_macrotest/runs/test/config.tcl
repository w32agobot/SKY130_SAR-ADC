...
set ::env(DESIGN_CONFIG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/config.tcl}
set ::env(DESIGN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest}
...
set ::env(EXTRA_GDS_FILES) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/src/delay_macrocell.gds}
set ::env(EXTRA_LEFS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/src/delay_macrocell.lef}
...
set ::env(FP_PIN_ORDER_CFG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/pin_order.cfg}
...
set ::env(GLB_CFG_FILE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/config.tcl}
...
set ::env(LIB_FASTEST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/src/sky130/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_SLOWEST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/src/sky130/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/src/sky130/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_TYPICAL) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/src/sky130/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports}
set ::env(RESULTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test}
...
set ::env(TMP_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp}
...
set ::env(VERILOG_FILES) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/src/adc_edge_detect_macrotest.v}
set ::env(WIDEN_SITE) {1}
set ::env(WIDEN_SITE_IS_FACTOR) {1}
set ::env(WIRE_RC_LAYER) {met1}
set ::env(YOSYS_REWRITE_VERILOG) {0}
set ::env(cts_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs/cts}
set ::env(cts_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports/cts}
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/cts}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/eco}
set ::env(floorplan_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/placement}
set ::env(routing_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs/routing}
set ::env(routing_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports/routing}
set ::env(routing_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/routing}
set ::env(signoff_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs/signoff}
set ::env(signoff_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports/signoff}
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/signoff}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_DEF) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/results/routing/adc_edge_detect_macrotest.def
set ::env(CURRENT_GUIDE) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/routing/12-global.guide
set ::env(CURRENT_INDEX) 24
set ::env(CURRENT_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/signoff/20-powered_netlist.v
set ::env(PREV_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_edge_detect_macrotest/runs/test/tmp/routing/14-detailed.v
