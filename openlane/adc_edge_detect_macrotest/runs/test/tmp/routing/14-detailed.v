module adc_edge_detect_macrotest (VGND,
    VPWR,
    in,
    out);
 input VGND;
 ...
 sky130_ef_sc_hd__decap_12 FILLER_1_122 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_1_134 (.VGND(VGND),
    .VPWR(VPWR),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_1_146 (.VGND(VGND),
    .VPWR(VPWR),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_99 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0_ (.A(net_2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(out));
 delay_macrocell delay_macrocell_0 (.in(in),
    .out(net_1),
    .VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 delay_macrocell delay_macrocell_1 (.in(net_1),
    .out(net_2),
    .VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
