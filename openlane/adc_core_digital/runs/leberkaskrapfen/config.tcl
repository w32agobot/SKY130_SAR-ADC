...
set ::env(CELLS_LEF) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef /foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_ef_sc_hd.lef}
set ::env(CELLS_LEF_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef /foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_ef_sc_hd.lef}
...
set ::env(GLB_CFG_FILE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/config.tcl}
...
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports}
set ::env(RESULTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen}
set ::env(RUN_DRT) {1}
...
set ::env(TMP_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp}
...
set ::env(VERILOG_FILES) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_core_digital.v /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_control_nonbinary.v /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_row_col_decoder.v /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_osr.v}
set ::env(WIRE_RC_LAYER) {met1}
set ::env(YOSYS_REWRITE_VERILOG) {0}
set ::env(cts_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/cts}
set ::env(cts_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/cts}
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/cts}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/eco}
set ::env(floorplan_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/placement}
set ::env(routing_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/routing}
set ::env(routing_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/routing}
set ::env(routing_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing}
set ::env(signoff_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/signoff}
set ::env(signoff_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/signoff}
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/signoff}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/synthesis}
...
set ::env(CURRENT_DEF) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.def
set ::env(CURRENT_GUIDE) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing/21-global.guide
set ::env(CURRENT_INDEX) 42
set ::env(CURRENT_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/signoff/37-powered_netlist.v
set ::env(PREV_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing/24-detailed.v
set ::env(PDK_ROOT) {/foss/pdk}
set ::env(ANTENNA_CHECK_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.def}
set ::env(ANTENNA_VIOLATOR_LIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/signoff/42-antenna_violators.rpt}
...
set ::env(CTS_TOLERANCE) {100}
set ::env(CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.def}
set ::env(CURRENT_GDS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/signoff/adc_core_digital.gds}
set ::env(CURRENT_GUIDE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing/21-global.guide}
set ::env(CURRENT_INDEX) {42}
set ::env(CURRENT_NETLIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/signoff/37-powered_netlist.v}
set ::env(CURRENT_SDC) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing/17-resizer_timing.sdc}
set ::env(CURRENT_SDF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.sdf}
set ::env(CURRENT_SPEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.nom.spef}
...
set ::env(DPL_CELL_PADDING) {2}
set ::env(DRC_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.def}
set ::env(DRC_EXCLUDE_CELL_LIST) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
set ::env(DRC_EXCLUDE_CELL_LIST_OPT) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
set ::env(DRT_OPT_ITERS) {64}
set ::env(ECO_ENABLE) {0}
...
set ::env(EXT_NETLIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/signoff/adc_core_digital.gds.spice}
set ::env(FAKEDIODE_CELL) {sky130_ef_sc_hd__fakediode_2}
set ::env(FILL_CELL) {sky130_fd_sc_hd__fill*}
set ::env(FILL_INSERTION) {1}
...
set ::env(LAST_TIMING_REPORT_TAG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/signoff/31-rcx_sta}
...
set ::env(LIB_CTS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/cts/cts.lib}
set ::env(LIB_FASTEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_RESIZER_OPT) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/synthesis/resizer_sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SLOWEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/synthesis/trimmed.lib}
set ::env(LIB_SYNTH_COMPLETE) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SYNTH_COMPLETE_NO_PG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib}
set ::env(LIB_SYNTH_MERGED) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/synthesis/merged.lib}
set ::env(LIB_SYNTH_NO_PG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/synthesis/1-trimmed.no_pg.lib}
set ::env(LIB_TYPICAL) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs}
set ::env(LVS_CONNECT_BY_LABEL) {0}
set ::env(LVS_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.def}
set ::env(LVS_INSERT_POWER_PINS) {1}
set ::env(MACRO_BLOCKAGES_LAYER) {li1 met1 met2 met3 met4}
set ::env(MAGIC_CONVERT_DRC_TO_RDB) {1}
set ::env(MAGIC_DISABLE_HIER_GDS) {1}
set ::env(MAGIC_DRC_USE_GDS) {1}
set ::env(MAGIC_EXT_USE_GDS) {1}
set ::env(MAGIC_GDS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/signoff/adc_core_digital.magic.gds}
set ::env(MAGIC_GENERATE_GDS) {1}
set ::env(MAGIC_GENERATE_LEF) {1}
set ::env(MAGIC_GENERATE_MAGLEF) {1}
set ::env(MAGIC_INCLUDE_GDS_POINTERS) {0}
...
set ::env(MERGED_LEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/merged.nom.lef}
set ::env(MERGED_LEF_MAX) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/merged.max.lef}
set ::env(MERGED_LEF_MIN) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/merged.min.lef}
...
set ::env(PARSITICS_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.def}
...
set ::env(PDK_ROOT) {/foss/pdk}
set ::env(PDN_CFG) {/foss/tools/openlane/2022.09/scripts/openroad/pdn_cfg.tcl}
set ::env(PLACEMENT_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/floorplan/6-pdn.def}
set ::env(PLACE_SITE) {unithd}
set ::env(PLACE_SITE_HEIGHT) {2.720}
set ::env(PLACE_SITE_WIDTH) {0.460}
set ::env(PL_BASIC_PLACEMENT) {0}
...
set ::env(RCX_CORNER_COUNT) {1}
set ::env(RCX_COUPLING_THRESHOLD) {0.1}
set ::env(RCX_LEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/merged.nom.lef}
...
set ::env(ROOT_CLK_BUFFER) {sky130_fd_sc_hd__clkbuf_16}
set ::env(ROUTING_CORES) {2}
set ::env(ROUTING_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/cts/14-resizer_timing.buffers_removed.def}
set ::env(RT_MAX_LAYER) {met4}
set ::env(RT_MIN_LAYER) {met1}
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen}
...
set ::env(SAVE_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.def}
set ::env(SAVE_GUIDE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing/21-global.guide}
set ::env(SAVE_NETLIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/signoff/37-powered_netlist.v}
set ::env(SAVE_SDC) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing/17-resizer_timing.sdc}
set ::env(SAVE_SDF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.sdf}
set ::env(SAVE_SPEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/routing/adc_core_digital.nom.spef}
...
set ::env(TOP_MARGIN_MULT) {4}
set ::env(TRACKS_INFO_FILE) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info}
set ::env(TRACKS_INFO_FILE_PROCESSED) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/routing/config.tracks}
set ::env(TRISTATE_BUFFER_MAP) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v}
set ::env(UNBUFFER_NETS) {^\$}
set ::env(USE_ARC_ANTENNA_CHECK) {1}
set ::env(USE_GPIO_PADS) {0}
...
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/cts}
set ::env(drc_prefix) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/signoff/drc}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/eco}
...
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/floorplan}
set ::env(fp_report_prefix) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/floorplan/3-initial_fp}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/placement}
...
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/signoff}
set ::env(synth_report_prefix) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/synthesis/1-synthesis}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/leberkaskrapfen/tmp/synthesis}
