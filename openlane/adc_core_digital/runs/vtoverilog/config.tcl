...
set ::env(DESIGN_CONFIG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/config.tcl}
...
set ::env(GLB_CFG_FILE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/config.tcl}
...
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs}
...
set ::env(REPORTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports}
set ::env(RESULTS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results}
...
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog}
set ::env(RUN_DRT) {1}
...
set ::env(RUN_TAG) {vtoverilog}
set ::env(SPEF_EXTRACTOR) {openrcx}
set ::env(START_TIME) {2022.10.24_14.46.22}
...
set ::env(TMP_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp}
...
set ::env(VERILOG_FILES) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_control_nonbinary.v /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_core_digital.v /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_osr.v /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/src/adc_row_col_decoder.v}
set ::env(WIRE_RC_LAYER) {met1}
set ::env(YOSYS_REWRITE_VERILOG) {0}
set ::env(cts_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/cts}
set ::env(cts_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/cts}
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/cts}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/eco}
set ::env(floorplan_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/floorplan}
set ::env(floorplan_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/floorplan}
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/floorplan}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/placement}
set ::env(routing_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/routing}
set ::env(routing_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/routing}
set ::env(routing_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing}
set ::env(routing_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing}
set ::env(signoff_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/signoff}
set ::env(signoff_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/signoff}
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/signoff}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/synthesis}
set ::env(SYNTH_MAX_TRAN) {0.75}
set ::env(CURRENT_DEF) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def
set ::env(CURRENT_GUIDE) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing/21-global.guide
set ::env(CURRENT_INDEX) 42
set ::env(CURRENT_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/signoff/37-powered_netlist.v
set ::env(PREV_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing/24-detailed.v
set ::env(PDK_ROOT) {/foss/pdk}
set ::env(ANTENNA_CHECK_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def}
set ::env(ANTENNA_VIOLATOR_LIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/signoff/42-antenna_violators.rpt}
...
set ::env(CONFIGS) {general.tcl checkers.tcl synthesis.tcl floorplan.tcl cts.tcl placement.tcl routing.tcl extraction.tcl lvs.tcl}
set ::env(CORE_AREA) {5.52 10.88 159.62 163.2}
set ::env(CORE_HEIGHT) {152.32}
set ::env(CORE_WIDTH) {154.1}
set ::env(CTS_CLK_BUFFER_LIST) {sky130_fd_sc_hd__clkbuf_8 sky130_fd_sc_hd__clkbuf_4 sky130_fd_sc_hd__clkbuf_2}
set ::env(CTS_CLK_MAX_WIRE_LENGTH) {0}
set ::env(CTS_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/placement/adc_core_digital.def}
set ::env(CTS_DISABLE_POST_PROCESSING) {0}
set ::env(CTS_DISTANCE_BETWEEN_BUFFERS) {0}
set ::env(CTS_MAX_CAP) {1.53169}
set ::env(CTS_REPORT_TIMING) {1}
...
set ::env(CTS_TOLERANCE) {100}
set ::env(CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def}
set ::env(CURRENT_GDS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/signoff/adc_core_digital.gds}
set ::env(CURRENT_GUIDE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing/21-global.guide}
set ::env(CURRENT_INDEX) {42}
set ::env(CURRENT_NETLIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/signoff/37-powered_netlist.v}
set ::env(CURRENT_SDC) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing/17-resizer_timing.sdc}
set ::env(CURRENT_SDF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.sdf}
set ::env(CURRENT_SPEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.nom.spef}
set ::env(CURRENT_STEP) {}
set ::env(CVC_SCRIPTS_DIR) {/foss/pdk/sky130A/libs.tech/openlane/cvc}
set ::env(DATA_WIRE_RC_LAYER) {met2}
set ::env(DBUS_SESSION_BUS_ADDRESS) {unix:abstract=/tmp/dbus-kSlzFTmWkh,guid=afe10a1374cc429b0a77451e63513aaa}
set ::env(DECAP_CELL) {sky130_ef_sc_hd__decap_12 sky130_fd_sc_hd__decap_8 sky130_fd_sc_hd__decap_6 sky130_fd_sc_hd__decap_4 sky130_fd_sc_hd__decap_3}
set ::env(DEFAULT_MAX_TRAN) {0.75}
set ::env(DEF_UNITS_PER_MICRON) {1000}
set ::env(DESIGNS) {/foss/designs}
set ::env(DESIGN_CONFIG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/config.tcl}
set ::env(DESIGN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital}
set ::env(DESIGN_IS_CORE) {0}
set ::env(DESIGN_NAME) {adc_core_digital}
set ::env(DESKTOP_SESSION) {xfce}
set ::env(DETAILED_ROUTER) {tritonroute}
set ::env(DIE_AREA) {0.0 0.0 165.59 176.31}
set ::env(DIODE_CELL) {sky130_fd_sc_hd__diode_2}
set ::env(DIODE_CELL_PIN) {DIODE}
set ::env(DIODE_INSERTION_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def}
set ::env(DIODE_INSERTION_STRATEGY) {3}
set ::env(DIODE_PADDING) {2}
set ::env(DISPLAY) {:1.0}
...
set ::env(DPL_CELL_PADDING) {2}
set ::env(DRC_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def}
set ::env(DRC_EXCLUDE_CELL_LIST) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
set ::env(DRC_EXCLUDE_CELL_LIST_OPT) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
set ::env(DRT_OPT_ITERS) {64}
set ::env(ECO_ENABLE) {0}
...
set ::env(EXT_NETLIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/signoff/adc_core_digital.gds.spice}
set ::env(FAKEDIODE_CELL) {sky130_ef_sc_hd__fakediode_2}
set ::env(FILL_CELL) {sky130_fd_sc_hd__fill*}
set ::env(FILL_INSERTION) {1}
...
set ::env(FP_PDN_ENABLE_MACROS_GRID) {1}
set ::env(FP_PDN_ENABLE_RAILS) {1}
set ::env(FP_PDN_HOFFSET) {19.040}
set ::env(FP_PDN_HORIZONTAL_HALO) {10}
set ::env(FP_PDN_HPITCH) {38.080}
set ::env(FP_PDN_HSPACING) {1.7}
set ::env(FP_PDN_HWIDTH) {1.6}
set ::env(FP_PDN_IRDROP) {1}
set ::env(FP_PDN_LOWER_LAYER) {met4}
...
set ::env(FP_PDN_UPPER_LAYER) {met5}
set ::env(FP_PDN_VERTICAL_HALO) {10}
set ::env(FP_PDN_VOFFSET) {19.260}
set ::env(FP_PDN_VPITCH) {38.525}
set ::env(FP_PDN_VSPACING) {1.7}
set ::env(FP_PDN_VWIDTH) {1.6}
set ::env(FP_SIZING) {relative}
set ::env(FP_TAPCELL_DIST) {13}
...
set ::env(HOSTNAME) {ee37278187d5}
set ::env(INPUT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/signoff/37-powered_def.def}
set ::env(IO_PCT) {0.2}
set ::env(KLAYOUT_DRC_KLAYOUT_GDS) {0}
set ::env(KLAYOUT_DRC_TECH_SCRIPT) {/foss/pdk/sky130A/libs.tech/klayout/drc/sky130A_mr.drc}
set ::env(KLAYOUT_PROPERTIES) {/foss/pdk/sky130A/libs.tech/klayout/tech/sky130A.lyp}
...
set ::env(LAST_TIMING_REPORT_TAG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/signoff/31-rcx_sta}
...
set ::env(LIB_CTS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/cts/cts.lib}
set ::env(LIB_FASTEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_RESIZER_OPT) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/synthesis/resizer_sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SLOWEST) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/synthesis/trimmed.lib}
set ::env(LIB_SYNTH_COMPLETE) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SYNTH_COMPLETE_NO_PG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib}
set ::env(LIB_SYNTH_MERGED) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/synthesis/merged.lib}
set ::env(LIB_SYNTH_NO_PG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/synthesis/1-trimmed.no_pg.lib}
set ::env(LIB_TYPICAL) {/foss/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs}
set ::env(LVS_CONNECT_BY_LABEL) {0}
set ::env(LVS_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def}
set ::env(LVS_INSERT_POWER_PINS) {1}
set ::env(MACRO_BLOCKAGES_LAYER) {li1 met1 met2 met3 met4}
set ::env(MAGIC_CONVERT_DRC_TO_RDB) {1}
set ::env(MAGIC_DISABLE_HIER_GDS) {1}
set ::env(MAGIC_DRC_USE_GDS) {1}
set ::env(MAGIC_EXT_USE_GDS) {1}
set ::env(MAGIC_GDS) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/signoff/adc_core_digital.magic.gds}
set ::env(MAGIC_GENERATE_GDS) {1}
set ::env(MAGIC_GENERATE_LEF) {1}
set ::env(MAGIC_GENERATE_MAGLEF) {1}
set ::env(MAGIC_INCLUDE_GDS_POINTERS) {0}
...
set ::env(MERGED_LEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/merged.nom.lef}
set ::env(MERGED_LEF_MAX) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/merged.max.lef}
set ::env(MERGED_LEF_MIN) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/merged.min.lef}
...
set ::env(PARSITICS_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def}
...
set ::env(PDK_ROOT) {/foss/pdk}
set ::env(PDN_CFG) {/foss/tools/openlane/2022.09/scripts/openroad/pdn_cfg.tcl}
set ::env(PLACEMENT_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/floorplan/6-pdn.def}
set ::env(PLACE_SITE) {unithd}
set ::env(PLACE_SITE_HEIGHT) {2.720}
set ::env(PLACE_SITE_WIDTH) {0.460}
set ::env(PL_BASIC_PLACEMENT) {0}
...
set ::env(RCX_CORNER_COUNT) {1}
set ::env(RCX_COUPLING_THRESHOLD) {0.1}
set ::env(RCX_LEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/merged.nom.lef}
...
set ::env(ROOT_CLK_BUFFER) {sky130_fd_sc_hd__clkbuf_16}
set ::env(ROUTING_CORES) {2}
set ::env(ROUTING_CURRENT_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/cts/14-resizer_timing.buffers_removed.def}
set ::env(RT_MAX_LAYER) {met4}
set ::env(RT_MIN_LAYER) {met1}
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog}
...
set ::env(SAVE_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.def}
set ::env(SAVE_GUIDE) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing/21-global.guide}
set ::env(SAVE_NETLIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/signoff/37-powered_netlist.v}
set ::env(SAVE_SDC) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing/17-resizer_timing.sdc}
set ::env(SAVE_SDF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.sdf}
set ::env(SAVE_SPEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital.nom.spef}
set ::env(SCRIPTS_DIR) {/foss/tools/openlane/2022.09/scripts}
set ::env(SESSION_MANAGER) {local/unix:@/tmp/.ICE-unix/50,unix/unix:/tmp/.ICE-unix/50}
set ::env(SHLVL) {2}
set ::env(SPEF_EXTRACTOR) {openrcx}
set ::env(SPEF_PREFIX) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/routing/adc_core_digital}
set ::env(SSH_AGENT_PID) {119}
set ::env(SSH_AUTH_SOCK) {/tmp/ssh-XXXXXXOOyhxg/agent.118}
set ::env(STARTUPDIR) {/dockerstartup}
set ::env(START_TIME) {2022.10.24_14.46.22}
set ::env(STA_LEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/merged.nom.lef}
...
set ::env(TOP_MARGIN_MULT) {4}
set ::env(TRACKS_INFO_FILE) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info}
set ::env(TRACKS_INFO_FILE_PROCESSED) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/routing/config.tracks}
set ::env(TRISTATE_BUFFER_MAP) {/foss/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v}
set ::env(UNBUFFER_NETS) {^\$}
set ::env(USE_ARC_ANTENNA_CHECK) {1}
set ::env(USE_GPIO_PADS) {0}
...
set ::env(cts_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/cts}
set ::env(cts_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/cts}
set ::env(drc_prefix) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/signoff/drc}
set ::env(eco_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/eco}
set ::env(eco_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/eco}
set ::env(eco_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/eco}
set ::env(eco_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/eco}
...
set ::env(floorplan_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/floorplan}
set ::env(floorplan_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/floorplan}
set ::env(fp_report_prefix) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/floorplan/3-initial_fp}
set ::env(placement_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/placement}
set ::env(placement_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/placement}
set ::env(placement_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/placement}
set ::env(placement_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/placement}
...
set ::env(signoff_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/signoff}
set ::env(signoff_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/signoff}
set ::env(synth_report_prefix) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/synthesis/1-synthesis}
set ::env(synthesis_logs) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/logs/synthesis}
set ::env(synthesis_reports) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/reports/synthesis}
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_core_digital/runs/vtoverilog/tmp/synthesis}
set ::env(timer_end) {1666623585}
set ::env(timer_routed) {1666623478}
set ::env(timer_start) {1666622782}
