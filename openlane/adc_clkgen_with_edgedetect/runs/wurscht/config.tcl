...
set ::env(START_TIME) {2022.10.28_16.30.28}
...
set ::env(CURRENT_DEF) /foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect/runs/wurscht/tmp/placement/5-global.def
set ::env(CURRENT_GUIDE) {0}
set ::env(CURRENT_INDEX) 6
set ::env(CURRENT_NETLIST) /foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect/runs/wurscht/results/synthesis/adc_clkgen_with_edgedetect.v
...
set ::env(CONFIGS) {general.tcl checkers.tcl synthesis.tcl floorplan.tcl cts.tcl placement.tcl routing.tcl extraction.tcl lvs.tcl}
set ::env(CORE_AREA) {5.52 2.72 166.06 59.84}
set ::env(CORE_HEIGHT) {57.12}
set ::env(CORE_WIDTH) {160.54}
set ::env(CTS_CLK_BUFFER_LIST) {sky130_fd_sc_hd__clkbuf_8 sky130_fd_sc_hd__clkbuf_4 sky130_fd_sc_hd__clkbuf_2}
set ::env(CTS_CLK_MAX_WIRE_LENGTH) {0}
set ::env(CTS_DISABLE_POST_PROCESSING) {0}
set ::env(CTS_DISTANCE_BETWEEN_BUFFERS) {0}
...
set ::env(DESIGN_NAME) {adc_clkgen_with_edgedetect}
set ::env(DETAILED_ROUTER) {tritonroute}
set ::env(DIE_AREA) {0.0 0.0 172.0 64.0}
set ::env(DIODE_CELL) {sky130_fd_sc_hd__diode_2}
set ::env(DIODE_CELL_PIN) {DIODE}
set ::env(DIODE_INSERTION_STRATEGY) {4}
set ::env(DIODE_PADDING) {2}
...
set ::env(LAST_TIMING_REPORT_TAG) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect/runs/wurscht/reports/synthesis/2-syn_sta}
...
set ::env(SAVE_DEF) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect/runs/wurscht/tmp/placement/5-global.macro_placement.def}
set ::env(SAVE_NETLIST) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect/runs/wurscht/results/synthesis/adc_clkgen_with_edgedetect.v}
...
set ::env(synthesis_results) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect/runs/wurscht/results/synthesis}
set ::env(synthesis_tmpfiles) {/foss/designs/SKY130_SAR-ADC/openlane/adc_clkgen_with_edgedetect/runs/wurscht/tmp/synthesis}
set ::env(timer_start) {1666974628}
set ::env(PDK_ROOT) {/foss/pdk}
set ::env(ATALANTA_MAN) {/usr/local/share/atalanta}
set ::env(BASE_SDC_FILE) {/foss/tools/openlane/2022.09/scripts/base.sdc}
set ::env(BASIC_PREP_COMPLETE) {1}
