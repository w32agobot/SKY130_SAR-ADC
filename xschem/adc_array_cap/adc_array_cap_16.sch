...
C {devices/capa.sym} 470 -190 0 0 {name=C3
m=1
value=7.87f
footprint=1206
device="ceramic capacitor"}
C {devices/iopin.sym} 110 -270 0 1 {name=p9 lab=CTOP}
C {devices/iopin.sym} 260 90 0 1 {name=p10 lab=VSS}
C {devices/lab_wire.sym} 470 -70 2 0 {name=l1 sig_type=std_logic lab=CBOT}
...
C {devices/lab_wire.sym} 860 -120 0 0 {name=l5 sig_type=std_logic lab=VCOM}
C {devices/lab_wire.sym} 940 -120 0 0 {name=l6 sig_type=std_logic lab=ROW_N}
C {devices/lab_wire.sym} 1020 -120 0 0 {name=l7 sig_type=std_logic lab=VDD}
C {adc_array_circuit.sym} 280 -50 0 0 {name=x1}
C {devices/capa.sym} 1110 -70 0 0 {name=C0
m=1
value=0.42f
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 1110 0 0 1 {name=l13 sig_type=std_logic lab=adc_array_circuit_0/VDRV}
C {devices/lab_wire.sym} 1110 -120 0 1 {name=l14 sig_type=std_logic lab=CBOT}
