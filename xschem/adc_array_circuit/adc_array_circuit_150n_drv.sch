...
N 300 -780 350 -780 {
lab=vcom}
C {devices/ipin.sym} 150 -590 0 0 {name=p1 lab=sample_n_in}
C {devices/ipin.sym} 160 -430 0 0 {name=p2 lab=sample_in}
...
C {devices/opin.sym} 930 -600 0 0 {name=p10 lab=sample_out}
C {devices/opin.sym} 920 -440 0 0 {name=p11 lab=sample_n_out}
