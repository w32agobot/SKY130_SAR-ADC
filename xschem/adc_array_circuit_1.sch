...
Input 110, 101 or 011} 1000 -820 0 0 0.4 0.4 {}
N 440 -470 470 -470 {
lab=vdrv}
N 440 -680 470 -680 {
lab=vdrv}
...
C {devices/ipin.sym} 880 -780 1 0 {name=p11 lab=rowoff_n}
C {devices/ipin.sym} 860 -780 1 0 {name=p12 lab=col}
C {devices/noconn.sym} 880 -770 3 0 {name=l8}
C {devices/noconn.sym} 860 -770 3 0 {name=l9}
