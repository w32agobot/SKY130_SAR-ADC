...
C {adc_clkgen_with_edgedetect.sym} 550 -430 0 0 {name=x1}
C {/foss/designs/SKY130_SAR-ADC/xschem/adc_comp_latch/adc_comp_latch.sym} 560 -660 0 0 {name=x2}
...
.save all 
.include /foss/designs/SKY130_Playground/howdoesthiswork/adc_clkgen_with_edgedetect.spice
*.OPTIONS savecurrents
*.OPTIONS RELTOL=.001 TRTOL=1 ABSTOL=1e-13 CHGTOL=1.0e-13 DEFAD=1.0e-13
