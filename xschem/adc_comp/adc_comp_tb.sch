...
C {adc_comp.sym} 250 -260 0 0 {name=x1}
C {devices/lab_wire.sym} 560 -280 0 0 {name=l2 sig_type=std_logic lab=clk}
C {devices/lab_wire.sym} 160 -340 0 0 {name=l3 sig_type=std_logic lab=nclk_int}
...
C {devices/vdd.sym} 160 -320 3 0 {name=l11 lab=VDD}
...
C {/foss/designs/SKY130_SAR-ADC/xschem/inverter/inverter.sym} 640 -280 0 0 {name=x2}
C {/foss/designs/SKY130_SAR-ADC/xschem/inverter/inverter.sym} 790 -280 0 0 {name=x3}
...
C {devices/lab_wire.sym} 160 -360 0 0 {name=l16 sig_type=std_logic lab=clk_int}
