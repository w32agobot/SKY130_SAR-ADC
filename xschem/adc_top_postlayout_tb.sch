...
C {devices/code.sym} 110 -1170 0 0 {name=TT_MODELS
only_toplevel=true
...
C {devices/simulator_commands.sym} 110 -1320 0 0 {name=COMMANDS
simulator=xyce
only_toplevel=false 
value="
* xyce commands
...
.include ../../spice/adc_top.gds.C.noD.postlayout.spice
...
****************
.tran 50n 650u
.print tran format=raw file=adc_top_postlayout_tb.raw v(*) i(*)
"}
C {devices/simulator_commands.sym} 250 -1320 0 0 {name=COMMANDS1
simulator=ngspice
only_toplevel=false 
value="
* ngspice commands
