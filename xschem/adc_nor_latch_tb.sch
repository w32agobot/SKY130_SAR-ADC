...
C {devices/vsource.sym} 120 -400 0 0 {name=V3 value="0.9 PULSE(0 1.8 6n 100p 100p 1n 10n)"}
C {devices/gnd.sym} 120 -350 0 0 {name=l7 lab=GND}
C {devices/vsource.sym} 120 -250 0 0 {name=V2 value="0.9 PULSE(0 1.8 1n 100p 100p 1n 10n)"}
...
C {adc_nor_latch.sym} 550 -330 0 0 {name=x1}
