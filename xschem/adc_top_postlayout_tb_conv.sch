...
C {devices/lab_wire.sym} 1200 -620 0 1 {name=l3 sig_type=std_logic lab=avg_mode[0..2],osr_mode[0..2],nc[0..3],dlyctrl4_[0..5]}
...
C {devices/lab_wire.sym} 740 -200 0 1 {name=l3 sig_type=std_logic lab=nc[0..3]}
